// package databasetest provides tools for launching and preparing databases
// in Docker containers to be used in tests. It has direct dependencies on
// the testing package to show that is shoud not be used for production code
